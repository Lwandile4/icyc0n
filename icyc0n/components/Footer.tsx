      ...
      <div className="w-[90%] lg:w-[90%] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Icycon is a modern AI-first growth platform. We leverage data and creativity to engineer results that matter.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-400">
              ...
              <li><Link to="/auth" className="hover:text-icy-main transition-colors">Contact Us</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-400">
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:hello@icycon.com" className="hover:text-icy-main transition-colors">
                  hello@icycon.com
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Phone size={16} className="text-icy-main" />
                <a href="tel:+18885550123" className="hover:text-icy-main transition-colors">
                  +1 (888) 555-0123
                </a>
              </li>
              <li className="flex items-center gap-3">
        ...
        <div className="relative pt-4 border-t border-white/10 flex justify-center md:justify-start items-center gap-6 overflow-hidden">
          <div className="flex gap-8">
            ...
            <a 
              href="https://instagram.com/icycon" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="text-gray-400 hover:text-white transition-colors"
            ...
            <a 
              href="https://linkedin.com/company/icycon" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="text-gray-400 hover:text-white transition-colors"
              aria-label="LinkedIn"
        ...
        <div className="relative pt-2 border-t border-white/10 flex justify-center items-center gap-6 overflow-hidden">
          <div className="text-sm text-gray-500">
            © 2026 Icycon. All rights reserved.
          </div>
