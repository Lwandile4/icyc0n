  ...
  return (
    <footer className="bg-black text-white pt-20 pb-10 px-4 border-t border-white/10">
      <div className="w-[90%] lg:w-[90%] mx-auto">
        ...
        <div className="relative pt-4 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6 overflow-hidden">
        ...
        <div className="relative pt-2 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6 overflow-hidden">
