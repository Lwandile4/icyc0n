...
import { Store, ShoppingBag, Briefcase, User, Smartphone, Globe, Building2 } from 'lucide-react';
          ...
          >
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-white/10 group">
              ...
              <div className="absolute bottom-8 left-8 right-8">
                ...
                <p className="text-gray-200">Our content merges strategic insight with creative execution. Designed not only to capture attention, but to convert it and guide each users towards meaningful action</p>
              </div>
            </div>
          </motion.div>
