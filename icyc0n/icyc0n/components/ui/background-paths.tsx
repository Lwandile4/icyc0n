...
function FloatingPaths({ position }: { position: number }) {
    ...
    return (
        <div className="absolute inset-0 pointer-events-none">
            <svg
                className="w-full h-full text-icy-main dark:text-white"
                viewBox="0 0 696 316"
                fill="none"
            >
...
export function BackgroundPaths({
    ...
    return (
        <div className="relative min-h-[60vh] md:min-h-screen w-full flex items-center justify-center overflow-hidden bg-white dark:bg-icy-dark">
            ...
            <div className="relative z-10 w-[90%] lg:w-[90%] mx-auto px-4 md:px-6 text-center">
                ...
                >
                    ...
                    >
                        {/* 
                           FIX: Use asChild to merge Button props onto Link 
                           This prevents <button> inside <a> nesting error
                        */}
                        <Button
                            asChild
                            variant="ghost"
